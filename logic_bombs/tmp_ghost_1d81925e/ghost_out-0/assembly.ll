; ModuleID = '/home/klee/tmp_ghost_1d81925e/ghost.bc'
source_filename = "/home/klee/tmp_ghost_1d81925e/ghost.c"
...
entry:
  ...
  store double %conv1, double* %d, align 8, !dbg !24
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [4 x i8]* %s, metadata !38, metadata !DIExpression()), !dbg !42
  %arraydecay = getelementptr inbounds [4 x i8], [4 x i8]* %s, i64 0, i64 0, !dbg !43
  call void @klee_make_symbolic(i8* %arraydecay, i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)), !dbg !44
  %arrayidx = getelementptr inbounds [4 x i8], [4 x i8]* %s, i64 0, i64 0, !dbg !45
  %0 = load i8, i8* %arrayidx, align 1, !dbg !45
  %conv = sext i8 %0 to i32, !dbg !45
  %cmp = icmp sge i32 %conv, 0, !dbg !46
  %conv1 = zext i1 %cmp to i32, !dbg !46
  %conv2 = sext i32 %conv1 to i64, !dbg !45
  call void @klee_assume(i64 %conv2), !dbg !47
  %arraydecay3 = getelementptr inbounds [4 x i8], [4 x i8]* %s, i64 0, i64 0, !dbg !48
  %call = call i32 @logic_bomb(i8* %arraydecay3), !dbg !49
  ret i32 0, !dbg !50
}
...
!1 = !DIFile(filename: "/home/klee/tmp_ghost_1d81925e/ghost.c", directory: "/home/klee")
!2 = !{}
...
!10 = !DIFile(filename: "tmp_ghost_1d81925e/ghost.c", directory: "/home/klee")
...
!27 = distinct !DILexicalBlock(scope: !9, file: !10, line: 13, column: 8)
!28 = !DILocation(line: 13, column: 10, scope: !27)
!29 = !DILocation(line: 13, column: 14, scope: !27)
!30 = !DILocation(line: 14, column: 9, scope: !31)
!31 = distinct !DILexicalBlock(scope: !27, file: !10, line: 13, column: 23)
!32 = !DILocation(line: 16, column: 9, scope: !33)
!33 = distinct !DILexicalBlock(scope: !27, file: !10, line: 15, column: 10)
!34 = !DILocation(line: 18, column: 1, scope: !9)
!35 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 20, type: !36, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!36 = !DISubroutineType(types: !37)
!37 = !{!13}
!38 = !DILocalVariable(name: "s", scope: !35, file: !10, line: 21, type: !39)
!39 = !DICompositeType(tag: DW_TAG_array_type, baseType: !15, size: 32, elements: !40)
!40 = !{!41}
!41 = !DISubrange(count: 4)
!42 = !DILocation(line: 21, column: 10, scope: !35)
!43 = !DILocation(line: 22, column: 24, scope: !35)
!44 = !DILocation(line: 22, column: 5, scope: !35)
!45 = !DILocation(line: 24, column: 17, scope: !35)
!46 = !DILocation(line: 24, column: 22, scope: !35)
!47 = !DILocation(line: 24, column: 5, scope: !35)
!48 = !DILocation(line: 25, column: 16, scope: !35)
!49 = !DILocation(line: 25, column: 5, scope: !35)
