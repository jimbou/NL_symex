...
entry:
  ...
  call void @klee_silent_exit(i32 0) #4, !dbg !25
  unreachable, !dbg !25
}
...
declare dso_local void @klee_silent_exit(i32) #2
...
entry:
  ...
  call void @klee_make_symbolic(i8* %arraydecay, i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)), !dbg !35
  ...
  %conv4 = sext i32 %1 to i64, !dbg !41
  call void @klee_assume(i64 %conv4), !dbg !42
  ret i32 0, !dbg !43
}
...
!26 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 25, type: !27, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!27 = !DISubroutineType(types: !28)
!28 = !{!6}
!29 = !DILocalVariable(name: "s", scope: !26, file: !3, line: 26, type: !30)
!30 = !DICompositeType(tag: DW_TAG_array_type, baseType: !17, size: 32, elements: !31)
!31 = !{!32}
!32 = !DISubrange(count: 4)
!33 = !DILocation(line: 26, column: 10, scope: !26)
!34 = !DILocation(line: 27, column: 24, scope: !26)
!35 = !DILocation(line: 27, column: 5, scope: !26)
!36 = !DILocation(line: 29, column: 17, scope: !26)
!37 = !DILocation(line: 29, column: 22, scope: !26)
!38 = !DILocation(line: 29, column: 5, scope: !26)
!39 = !DILocation(line: 30, column: 16, scope: !26)
!40 = !DILocation(line: 30, column: 5, scope: !26)
!41 = !DILocation(line: 31, column: 17, scope: !26)
!42 = !DILocation(line: 31, column: 5, scope: !26)
!43 = !DILocation(line: 32, column: 5, scope: !26)
