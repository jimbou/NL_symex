...
entry:
  ...
  %arraydecay1 = getelementptr inbounds [4 x i8], [4 x i8]* %input, i64 0, i64 0, !dbg !48
  %call = call i32 @logic_bomb(i8* %arraydecay1), !dbg !49
  ret i32 %call, !dbg !50
}
...
!46 = !DILocation(line: 24, column: 5, scope: !36)
!47 = !DILocation(line: 24, column: 14, scope: !36)
!48 = !DILocation(line: 25, column: 23, scope: !36)
!49 = !DILocation(line: 25, column: 12, scope: !36)
